...
const STEPS = [
  { n: '01', title: 'Dale vida a tu Pandi',   desc: 'En 2 minutos calibramos tu perfil: altura, peso, objetivo, horarios, restricciones y tratamientos médicos activos.' },
  { n: '02', title: 'Pandi te refleja',        desc: 'Calculamos tu TDEE, tus macros óptimos y Pandi adopta tu estado biológico desde el primer día.' },
  { n: '03', title: 'Crecéis juntos',          desc: 'Registra comidas, entrenos y sueño. Pandi analiza tus patrones y ajusta el plan cada semana.' },
]

const FAQS = [
  { q: '¿Qué diferencia a Pandi de MyFitnessPal o Cronometer?', a: 'Pandi usa tu perfil clínico completo — tratamientos médicos, analíticas, horarios laborales y patrones de sueño — para dar recomendaciones contextualizadas. No es un contador de calorías, es un coach que te conoce.' },
  { q: '¿Mis datos médicos están seguros?', a: 'Sí. Tus datos se almacenan con cifrado en reposo y en tránsito. Cumplimos con el RGPD. Nunca vendemos ni compartimos tus datos con terceros.' },
  { q: '¿El Coach IA sustituye a un médico o nutricionista?', a: 'No. Pandi es una herramienta de apoyo y seguimiento. Las recomendaciones son orientativas y no sustituyen el consejo de un profesional de la salud.' },
  ...
  { q: '¿Qué incluye el plan gratuito?', a: 'Diario nutricional, entrenamiento, seguimiento de sueño y ánimo, hidratación, mascota Pandi y Coach IA con 10 mensajes diarios. Sin fecha de caducidad.' },
]
      ...
      <nav className="sticky top-0 z-50" style={{ background: 'rgba(255,255,255,0.92)', backdropFilter: 'blur(20px)', borderBottom: `1px solid ${C.border}` }}>
        <div className="max-w-5xl mx-auto px-4 h-16 flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <span className="font-extrabold text-lg" style={{ color: C.text }}>Pandi</span>
          </div>
          ...
          <div className="flex items-center gap-3">
            ...
            <Link to="/auth" className="text-sm font-bold px-4 py-2 rounded-xl text-white"
        ...
        <div className="max-w-5xl mx-auto px-4">
          <div className="flex flex-wrap justify-center gap-8 items-center">
            {[
              ...
              { v: '94%',   l: 'mejoran hábitos en 30 días' },
            ].map(({ v, l }) => (
            ...
            {STEPS.map(({ n, title, desc }, i) => (
              <motion.div key={n} initial={{ opacity: 0, x: -20 }} whileInView={{ opacity: 1, x: 0 }}
                ...
                <div className="w-12 h-12 rounded-2xl flex items-center justify-center font-extrabold text-sm flex-shrink-0"
                  style={{ background: C.grad, color: '#fff' }}>{n}</div>
                <div className="pt-1">
          ...
          <div className="rounded-3xl p-8 md:p-12 flex flex-col md:flex-row items-center gap-10"
            ...
            <div className="flex-1">
              ...
              <p className="mb-6" style={{ color: C.muted, lineHeight: 1.7 }}>
                Pregúntale qué comer antes de entrenar teniendo en cuenta que tomas Ozempic y que tienes la vitamina D baja. Él lo sabe.
              </p>
          ...
          <div className="grid md:grid-cols-3 gap-5">
            {[
              ...
              <motion.div key={name} whileHover={{ y: -4 }} transition={{ duration: 0.2 }}
                className="rounded-2xl p-6" style={{ background: C.surface, border: `1px solid ${C.border}` }}>
        ...
        <div className="max-w-3xl mx-auto">
          <div className="text-center mb-12">
            ...
            <h2 className="font-extrabold mb-3" style={{ fontSize: 'clamp(1.6rem, 3vw, 2.2rem)', color: C.text }}>
              Empieza gratis.<br /><GradText>Evoluciona cuando quieras.</GradText>
            </h2>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="rounded-2xl p-7" style={{ background: C.bg, border: `1px solid ${C.border}` }}>
              ...
              <Link to="/auth" className="block w-full text-center py-3 rounded-xl font-semibold text-sm"
            ...
            <div className="rounded-2xl p-7 relative" style={{ background: C.text, border: `2px solid ${C.primary}` }}>
              <div className="absolute -top-3 left-1/2 -translate-x-1/2 text-white text-xs font-bold px-4 py-1 rounded-full"
                style={{ background: C.grad }}>MÁS POPULAR</div>
              ...
              <Link to="/auth" className="block w-full text-center py-3 rounded-xl font-bold text-sm text-white"
                style={{ background: C.grad }}>Probar 7 días gratis</Link>
            </div>
          </div>
        ...
        <div className="max-w-2xl mx-auto text-center">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}
            ...
            <p className="mb-8" style={{ color: C.muted, lineHeight: 1.7 }}>
              Únete a más de 500 personas que ya están mejorando su salud con datos reales. Empieza hoy. Gratis.
            </p>
            <Link to="/auth" className="inline-flex items-center gap-2 px-8 py-4 rounded-2xl text-white font-bold text-base"
              ...
              Dale vida a tu Pandi <ArrowRight size={16} />
            </Link>
      ...
      <footer style={{ background: C.text, padding: '3rem 1rem 2rem' }}>
        <div className="max-w-5xl mx-auto">
          <div className="flex flex-col md:flex-row justify-between items-start gap-8 mb-8">
            <div>
              <div className="flex items-center gap-2 mb-3">
                <img src="/icons/icon-192.png" alt="Pandi" style={{ width: 32, height: 32, borderRadius: 8 }} />
                <span className="font-extrabold text-lg text-white">Pandi Health Coach</span>
              </div>
              ...
              <p className="text-xs mt-3 max-w-xs" style={{ color: 'rgba(255,255,255,0.3)', lineHeight: 1.5 }}>
                ⚕️ Pandi no proporciona consejo médico. La información generada es orientativa y no sustituye la opinión de un profesional sanitario.
              </p>
            </div>
              ...
              {Object.entries(FOOTER_LINKS).map(([section, links]) => (
                <div key={section}>
                  ...
                  {links.map(({ label, to, href }) => (
                    to ? (
                      <Link key={label} to={to} className="block text-sm mb-2 hover:text-white transition-colors"
                        style={{ color: 'rgba(255,255,255,0.6)' }}>{label}</Link>
                    ) : (
                      <a key={label} href={href} className="block text-sm mb-2 hover:text-white transition-colors"
          ...
          <div style={{ borderTop: '1px solid rgba(255,255,255,0.08)', paddingTop: '1.5rem' }}
            ...
            <p className="text-xs" style={{ color: 'rgba(255,255,255,0.3)' }}>© 2026 Pandi Health Coach. Todos los derechos reservados.</p>
