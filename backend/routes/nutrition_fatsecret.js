...
const LOCAL_ES = [
  ...
  // ─── COMIDAS COMBINADAS ESPAÑOLAS ────────────────────────────────────────
  { name:'Leche con ColaCao',          calories:95,  protein:4,  carbs:14, fat:3,  fiber:0.5 },
  { name:'Leche con Nesquik',           calories:90,  protein:4,  carbs:12, fat:3,  fiber:0.3 },
  { name:'Leche con galletas María',    calories:245, protein:7,  carbs:38, fat:7,  fiber:0.8 },
  { name:'Leche con cereales',          calories:220, protein:6,  carbs:36, fat:5,  fiber:1.5 },
  { name:'Tostadas con tomate y aceite',calories:180, protein:5,  carbs:28, fat:6,  fiber:2.0 },
  { name:'Tostadas con mantequilla',    calories:280, protein:5,  carbs:32, fat:14, fiber:1.5 },
  { name:'Tostadas con jamón',          calories:250, protein:14, carbs:28, fat:8,  fiber:1.2 },
  { name:'Pan con aceite y sal',        calories:200, protein:4,  carbs:30, fat:8,  fiber:1.8 },
  { name:'Arroz con huevo frito',       calories:380, protein:16, carbs:45, fat:13, fiber:0.3 },
  { name:'Arroz con huevo y tomate',    calories:420, protein:17, carbs:52, fat:14, fiber:1.5 },
  { name:'Arroz con pollo',             calories:350, protein:26, carbs:38, fat:9,  fiber:0.5 },
  { name:'Arroz con atún',              calories:290, protein:20, carbs:38, fat:4,  fiber:0.3 },
  { name:'Pasta con tomate',            calories:250, protein:8,  carbs:48, fat:4,  fiber:2.5 },
  { name:'Pasta con atún y tomate',     calories:380, protein:26, carbs:50, fat:7,  fiber:2.8 },
  { name:'Macarrones con queso',        calories:420, protein:18, carbs:52, fat:14, fiber:1.8 },
  { name:'Bocadillo de jamón',          calories:380, protein:22, carbs:45, fat:10, fiber:2.0 },
  { name:'Bocadillo de tortilla',       calories:420, protein:18, carbs:48, fat:16, fiber:1.5 },
  { name:'Bocadillo de atún',           calories:340, protein:22, carbs:45, fat:7,  fiber:2.0 },
  { name:'Bocadillo de queso',          calories:450, protein:20, carbs:45, fat:20, fiber:1.8 },
  { name:'Bocadillo de pollo',          calories:360, protein:28, carbs:42, fat:8,  fiber:2.0 },
  { name:'Pollo con patatas',           calories:380, protein:30, carbs:28, fat:16, fiber:2.5 },
  { name:'Pollo con arroz',             calories:370, protein:32, carbs:36, fat:8,  fiber:0.5 },
  { name:'Lentejas con chorizo',        calories:340, protein:20, carbs:42, fat:10, fiber:9.0 },
  { name:'Garbanzos con espinacas',     calories:220, protein:11, carbs:30, fat:5,  fiber:9.5 },
  { name:'Tortilla con ensalada',       calories:310, protein:17, carbs:14, fat:19, fiber:2.5 },
  { name:'Revuelto de gambas',          calories:230, protein:22, carbs:2,  fat:15, fiber:0.0 },
  { name:'Revuelto de espinacas',       calories:210, protein:16, carbs:4,  fat:14, fiber:2.2 },
  { name:'Merluza con patatas',         calories:260, protein:22, carbs:22, fat:6,  fiber:2.0 },
  { name:'Salmón con patatas',          calories:380, protein:28, carbs:22, fat:18, fiber:2.0 },
  { name:'Ensalada mixta',              calories:85,  protein:3,  carbs:10, fat:4,  fiber:2.5 },
  { name:'Ensalada de pasta',           calories:280, protein:9,  carbs:42, fat:8,  fiber:3.0 },
  { name:'Ensalada César',              calories:220, protein:12, carbs:10, fat:15, fiber:2.0 },
  { name:'Caldo con fideos',            calories:80,  protein:4,  carbs:12, fat:1,  fiber:0.5 },
  { name:'Sopa de verduras',            calories:70,  protein:3,  carbs:12, fat:1,  fiber:3.0 },
  { name:'Crema de calabaza',           calories:90,  protein:2,  carbs:14, fat:4,  fiber:2.5 },
  { name:'Batido de plátano y leche',   calories:180, protein:6,  carbs:32, fat:3,  fiber:2.0 },
  { name:'Avena con leche',             calories:280, protein:11, carbs:44, fat:6,  fiber:5.0 },
  { name:'Yogur con frutas',            calories:130, protein:5,  carbs:22, fat:2,  fiber:2.0 },
  { name:'Yogur con granola',           calories:210, protein:6,  carbs:32, fat:6,  fiber:2.5 },
  { name:'Fruta variada',               calories:80,  protein:1,  carbs:20, fat:0,  fiber:3.0 },
