...
import { Home, CalendarDays, Apple, Dumbbell, Heart } from 'lucide-react'
...
export default function BottomNav() {
  ...
  return (
    <nav
      ...
      {/* 1. INICIO */}
      <NavLink to="/home" className="flex-1 flex flex-col items-center justify-center h-full">
      ...
      {/* 2. BIENESTAR */}
      <NavLink to="/mood" className="flex-1 flex flex-col items-center justify-center h-full">
        <Heart size={22} color={isMood ? theme.navActive : theme.navText} />
        <span className="text-[10px] font-medium mt-1"
          style={{ color: isMood ? theme.navActive : theme.navText }}>
          Bienestar
        </span>
      </NavLink>

      {/* 3. ORGANIZADOR — trono central */}
        ...
        <NavLink to="/calendar"
          ...
          <motion.div whileTap={{ scale:0.92 }}
            style={{ width:58, height:58, borderRadius:'50%',
              ...
              border:'4px solid white', margin:'0 auto' }}>
            <CalendarDays size={26} color="#fff" strokeWidth={1.8} />
          </motion.div>
          <span className="text-[10px] font-bold mt-1 block w-full"
